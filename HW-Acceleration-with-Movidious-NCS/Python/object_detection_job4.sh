...
python3 tutorial1.py                        -m $HOME/Reference-samples/smart-video-workshop/object-detection/Python/models/object_detection/common/mobilenet-ssd/${FP_MODEL}/${NN_MODEL}  \
                                            -i $INPUT_FILE \
                                            -o $RESULTS_PATH \
                                            -d $DEVICE \
